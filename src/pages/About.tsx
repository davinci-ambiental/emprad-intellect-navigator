...
const About: React.FC = () => {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-emprad-purple py-16">
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="bg-white rounded-lg shadow-md p-8 mb-8">
          <h2 className="text-2xl font-bold text-emprad-purple mb-4">Nossa Missão</h2>
          ...
          <h2 className="text-2xl font-bold text-emprad-purple mb-4">História</h2>
          <p className="text-gray-700 mb-6">
          ...
          <h2 className="text-2xl font-bold text-emprad-purple mb-4">Objetivos</h2>
          ...
          <h2 className="text-2xl font-bold text-emprad-purple mb-4">EMPRAD 2025</h2>
        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          <h2 className="text-2xl font-bold text-emprad-purple mb-4">Contato</h2>
          <p className="text-gray-700 mb-4">
            Para mais informações sobre o EMPRAD, entre em contato conosco:
          </p>
          <div className="space-y-2">
            <p className="text-gray-700"><strong>E-mail:</strong> contato@emprad.org.br</p>
            <p className="text-gray-700"><strong>Telefone:</strong> (11) 3456-7890</p>
            <p className="text-gray-700"><strong>Endereço:</strong> Rua da Universidade, 123 - São Paulo/SP</p>
          </div>
        </div>
      </div>
    </div>
